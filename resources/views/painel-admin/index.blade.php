    ...
    <!------ Include the above in your HEAD tag ---------->
        <div class="container">
            ...
            <table class="table table-striped custab">
                <thead>
                    <a href="/produtos/novo" class="btn btn-primary btn-xs pull-right"><b>+</b> Adicionar novo produto</a>
                    <tr>
                        <th>ID</th>
                        <th>Produto</th>
                        <th>Preço</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a href="/produtos/apagar/{{ $produto->id }}" class="btn btn-danger btn-xs">
